...
ENCODER_FILENAME = "ti_order_encoder.pt"
EMB_FILENAME = "ti_train_embeddings.pt"

RAW_FILENAME = "ti_train_raw.pt"
TRAIN_FILENAME = "ti_train.pt"
VAL_FILENAME = "ti_val.pt"
TEST_FILENAME = "ti_test.pt"
...
from src.datasets.ti_dataset_order_embedding import (
    TIGraphDataset,
    train_order_encoder,
...
def main():
    datadir = os.path.join(PROJECT_ROOT, "data", "TI")
