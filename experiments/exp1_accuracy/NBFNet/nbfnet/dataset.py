...
@core.Registry.register("MyCustomDataset")
class MyCustomDataset(data.KnowledgeGraphDataset):
    urls = [] # 我们使用本地文件，不需要从网络下载
    ...
    def __init__(self, path, verbose=1, **kwargs):
        ...
        # 将这些文件加载进 TorchDrug 的后端中
        self.load_tsvs([train_file, valid_file, test_file], verbose=verbose)
